...
function Moffeus:initialize()
	...
	self.hud = Hud:new(0,0,self)
	self:addEntity(self.hud, self.layers.gui)

	self.explodeSound =  self.soundmgr:addSound("explo1.mp3",false,1.0)
	self.explodeSound2 = self.soundmgr:addSound("explo2.mp3",false,1.0)
	self.explodeSound3 = self.soundmgr:addSound("explo3.mp3",false,1.0)
